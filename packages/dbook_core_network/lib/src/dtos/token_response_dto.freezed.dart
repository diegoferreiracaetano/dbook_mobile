...
bool operator ==(Object other) {
  final _this = this as TokenResponseDto;
  return identical(this, other) || (other.runtimeType == runtimeType&&other is TokenResponseDto&&(identical(other.accessToken, _this.accessToken) || other.accessToken == _this.accessToken)&&(identical(other.refreshToken, _this.refreshToken) || other.refreshToken == _this.refreshToken));
}
...
String toString() {
  final _this = this as TokenResponseDto;
  return 'TokenResponseDto(accessToken: ${_this.accessToken}, refreshToken: ${_this.refreshToken})';
}
...
class _TokenResponseDto extends TokenResponseDto {
  const _TokenResponseDto({required this.accessToken, required this.refreshToken}): super._();
